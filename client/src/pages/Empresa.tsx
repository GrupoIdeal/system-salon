        ...
        <DashboardLayout>
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">Gerencie os dados básicos da empresa</p>
                </div>
                <div>
                    {editMode ? (
                        <Button
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                <strong>Importante:</strong> Os horários de funcionamento agora são configurados individualmente para cada especialista.
                                Vá para a seção "Especialistas" para definir os horários de trabalho de cada profissional.
                            </AlertDescription>
                        </Alert>
                    </CardContent>
                </Card>
