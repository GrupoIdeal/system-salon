            ...
            <DialogContent className="w-full max-w-4xl md:max-w-5xl lg:max-w-6xl max-h-[90vh] overflow-y-auto mx-auto my-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="timeSlotDuration">Duração do Slot (min)</Label>
                                                <Select
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="minimumNoticeHours">Antecedência mínima (h)</Label>
                                                <Input
                                                    type="number"
                                                    min="0"
                                                    max="72"
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Configure dias, horário e pausas</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <Table>
                                            <TableHeader>
                            ...
                            <>
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Férias, feriados e bloqueios</CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                ...
                                <Card className="bg-blue-50 border-blue-200">
                                    ...
                                    <CardContent className="space-y-2 text-sm">
                                        <p><strong>Slots:</strong> {scheduleQuery.data.timeSlotDuration} min</p>
                                        <p><strong>Intervalo:</strong> {scheduleQuery.data.bufferTime} min</p>
                                        ...
                                        <div className="pt-2 border-t border-blue-200">
                                            ...
                                            <div className="flex flex-wrap gap-1 mt-2">
                                                {scheduleQuery.data.workingHoursFormatted
                                                    ...
                                                    .map((d: any) => (
                                                        <Badge key={d.dayOfWeek} variant="outline" className="text-xs">
                ...
                <DialogFooter className="pt-4">
                    <div className="flex items-center justify-end gap-2 w-full">
                        ...
                        <Button
                            onClick={() => { scheduleQuery.refetch(); toast.success('Alterações salvas'); }}
