...
type ReportKey = "stats" | "specialists" | "services" | "clients" | "daily";
type ExportReportType = "appointments" | "specialists" | "services" | "clients";
...
export function ReportsManagement({ isOpen, onClose }: ReportsManagementProps) {
  const [selectedReport, setSelectedReport] = useState<ReportKey>("stats");
  ...
  const specialistPerformanceQuery =
    trpc.reports.specialistPerformance.useQuery({
      startDate: new Date(dateFilter.startDate),
      endDate: new Date(dateFilter.endDate),
    });
  ...
  // Mutation para exportar CSV (uso imperativo do servidor)
        ...
        <div className="flex space-x-1 border-b">
          {[
            ...
            <Button
              ...
              size="sm"
              onClick={() => setSelectedReport(id as ReportKey)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Apenas agendamentos completados
                    </p>
                  </CardContent>
                </Card>
        ...
        {selectedReport === "specialists" && (
          <div className="space-y-6">
            ...
            {specialistPerformanceQuery.isLoading ? (
              ...
              <Table>
                <TableCaption>
                  Performance de {specialistPerformanceQuery.data.length}{" "}
                  especialista(s)
                </TableCaption>
                <TableHeader>
                  <TableRow>
                ...
                <TableBody>
                  {specialistPerformanceQuery.data.map(specialist => (
                    <TableRow key={specialist.specialistId}>
                      ...
                      <TableCell>
                        {formatCurrency(specialist.averageTicket)}
                      </TableCell>
                      <TableCell>
        ...
        {selectedReport === "services" && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Button
                onClick={() =>
                  handleExportCSV("services", servicePopularityQuery.data)
                }
            ...
            {servicePopularityQuery.isLoading ? (
              ...
              <Table>
                ...
                <TableBody>
                  {servicePopularityQuery.data.map(service => (
                    <TableRow key={service.serviceId}>
                      ...
                      <TableCell>
                        {formatCurrency(service.averageTicket)}
                      </TableCell>
                      <TableCell>
        ...
        {selectedReport === "clients" && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Button
                onClick={() =>
                  handleExportCSV("clients", clientAnalyticsQuery.data?.all)
                }
                ...
                {clientAnalyticsQuery.data.highRisk.length > 0 && (
                  <Card className="border-red-200 bg-red-50">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Clientes que podem estar prestes a parar de frequentar o
                        salão
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                        {clientAnalyticsQuery.data.highRisk
                          .slice(0, 5)
                          .map(client => (
                            <div
                              key={client.clientId}
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {dailyReportQuery.data.totalAppointments}
                      </div>
                      <p className="text-xs text-muted-foreground">
                        {dailyReportQuery.data.completedAppointments}{" "}
                        completados
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {dailyReportQuery.data.cancelledAppointments}{" "}
                        cancelamentos
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-1">
                        {dailyReportQuery.data.busyHours
                          .slice(0, 3)
                          .map(hour => (
                            <div
                              key={hour.hour}
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {dailyReportQuery.data.busyHours.map(hour => {
                        ...
                        const percentage =
                          maxCount > 0
                            ? (hour.appointmentCount / maxCount) * 100
                            : 0;
